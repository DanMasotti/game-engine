...
View::View(QWidget *parent) : QGLWidget(ViewFormat(), parent),
    ...
    m_graphics(nullptr),
    m_application(nullptr) //TODO: Manage Applications better than this
{
    /** SUPPORT CODE START **/    
...
void View::initializeGL()
{
    ...
    m_application = std::make_shared<Platformer::PlatformerGame>();
}
...
void View::paintGL()
{
    ...
    m_graphics->setClearColor(glm::vec3(0.3, 0.9, 0.3));
...
void View::mousePressEvent(QMouseEvent *event)
{
    ...
    m_application->onMousePress(event, deltaX, deltaY);
}
...
void View::mouseMoveEvent(QMouseEvent *event)
{
    ...
    m_application->onMouseMove(deltaX, deltaY);
}
...
void View::mouseReleaseEvent(QMouseEvent *event)
{
    ...
    m_application->onMouseRelease(event, deltaX, deltaY);
}
...
void View::wheelEvent(QWheelEvent *event)
{
    ...
    m_application->onMouseWheel(deltaX, deltaY);
}
...
void View::keyReleaseEvent(QKeyEvent *event)
{
    ...
    m_application->onKeyRelease(event);
}
